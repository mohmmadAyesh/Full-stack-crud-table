...
// it will create the initial configuration of database like creating tables
...
// it will insert data to database
...
// invoking a closure which will run automatically when we execute the file through node
(async () => {
