...
import {WrapperTable,Thead,Th,TBody,TableRow,Td} from './Table.styles.js';
import Button from '../Button/Button.jsx';
const Table = ({setOpenPopUp,data,setCurrentRecordToUpdate,setDelete}) => {
  console.log(data);
  return (
    <WrapperTable>
      <Thead>
      ...
      <TBody>
        {data && data.map((element)=>{
            ...
            <Button Action={()=>{
                setOpenPopUp(true);
                setCurrentRecordToUpdate(element);
...
<rect width="19" height="19" fill="white"/>
          ...
          <Td>
            <Button Action={()=>setDelete(element.id)}>
