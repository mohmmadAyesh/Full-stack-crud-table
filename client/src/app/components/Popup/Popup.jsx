    ...
    <Wrapper>
      <form onSubmit={(e) => handleUpdate(e,currentRecordToUpdate.id)}>
        ...
        <Field>
          ...
          <Input id='price_input' name="price" type="number" step="0.01" defaultValue={ currentRecordToUpdate.price }/>
        </Field>
        <Field>
          <Label htmlFor='note_input'>note</Label>
          <Input id="note_input"  name="note" type="text" defaultValue={ currentRecordToUpdate.note }/>
        </Field>
        <Field>
          <Label htmlFor='volume_input'>volume</Label>
          <Input id='volume_input' name="volume" type="number" defaultValue={currentRecordToUpdate.volume}/>
        </Field>
